...
const specials=[
  ...
  {y:2026,m:6,d:26,title:'KM Bleu TDF',color:'#122b44',tags:[{l:'KM Bleu',c:'tag-km'},{l:'Ouvert à tous',c:'tag-open'}],time:'14h00',dur:180,desc:"Pas de run cette fois : on installe le Kilomètre Bleu rue Lepic pour mettre l'ambiance et pousser les cyclistes du Tour de France dans la montée. Cris, drapeaux et tambours, l'équipe orga est sur place dès 10h.",details:[['Lieu','Rue Lepic, Paris 18e'],['Horaire','Sur place dès 10h'],['Accès','Ouvert à tous']],location:'Rue Lepic, Paris 18e'},
  {y:2026,m:5,d:28,title:"L'Or Espresso x CIELBLEU - 2ème édition",color:'#c4956a',tags:[{l:'KM Bleu',c:'tag-km'},{l:'Ouvert à tous',c:'tag-open'}],time:'9h45',dur:90,desc:"Run de 8 km dans Saint-Germain-des-Prés, suivi d'une dégustation gratuite des créations de L'Or Espresso. Allure 6:15/km pour s'adapter aux conditions météo. Limité à 35 places sur inscription.",details:[['Lieu',"L'Or Espresso · 77 bd Saint-Germain, 75006"],['Horaire','9h45'],['Distance','8 km · allure 6:15/km'],['Accès','35 places · inscription obligatoire'],['Métro','Odéon M4 / M10']],location:'75006 Paris'},
  {y:2026,m:6,d:22,title:'Run découverte CIELBLEU × Fitzroy',color:'#b6cde0',tags:[{l:'Ouvert à tous',c:'tag-open'},{l:'Partenariat',c:'tag-partner'}],time:'19h20',dur:70,desc:"Run découverte en partenariat avec Fitzroy, ouvert à tous. Le dernier rendez-vous avant la pause estivale du club.",details:[['Lieu','Quais de Seine · Paris'],['Horaire','19h20'],['Accès','Ouvert à tous']],location:'Quais de Seine, Paris'},
